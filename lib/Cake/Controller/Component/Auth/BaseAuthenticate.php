 ...
 */
	public $settings = array(
		...
		'userModel' => 'User',
		'userFields' => array('User.id', 'User.nombre', 'User.a_paterno', 'User.a_materno', 'User.tipo_user', 'User.empresa_id', 'User.username', 'User.activo', 'Empresa.activo', 'Empresa.fecha_corte'),
		'scope' => array(),
		'recursive' => 0,
		'contain' => null,
